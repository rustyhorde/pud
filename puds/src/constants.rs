...
/// The configuration file base path
pub(crate) const CONFIG_FILE_BASE_PATH: &str = "puds";
/// The configuration file base name
pub(crate) const CONFIG_FILE_NAME: &str = concatcp!(CONFIG_FILE_BASE_PATH, ".toml");
